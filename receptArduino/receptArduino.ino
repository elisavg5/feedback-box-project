...
//Data Model--> 1,3,35!2,2,36!1,2,37 with question,answer,seqNb and ! as a data separator 
...
void setup() {
  ...
  if (!LoRa.begin(868E6)) { //here we choose 868MHz as communication frequency : it has to be the same frequency for both receptor and transmitter
